...
# ДОБАВИТЬ В companion.py:

class RealisticAICompanion:
    def __init__(self, config: Dict[str, Any]):
        # ... существующий код ...
        
        # НОВОЕ: Система виртуальной жизни
        ...
        # Добавляем проверку активностей в планировщик
        self.scheduler.add_job(
            self.update_virtual_life,
            IntervalTrigger(minutes=1),  # Проверяем каждую минуту
    ...
    async def _notify_activity_start(self, activity: VirtualActivity):
        ...
        # Генерируем сообщение о начале активности
        messages = [
        ...
        # Отправляем если есть активные пользователи
...
# Добавить в AI промпт контекст виртуальной жизни